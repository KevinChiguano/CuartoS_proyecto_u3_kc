...
public class FacturaElectronica {
	...
	@Id
	@Column(name = "fael_id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "fael_id_seque")
	@SequenceGenerator(name = "fael_id_seque", sequenceName = "fael_id_seque", allocationSize = 1)
	private Integer id;
